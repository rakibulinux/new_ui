...
export const selectUserActivityPageCount = (state: RootState, limit): number => Math.ceil(state.user.userActivity.total / limit);

export const selectUserActivityFirstElemIndex = (state: RootState, limit): number => state.user.userActivity.page * limit + 1;
