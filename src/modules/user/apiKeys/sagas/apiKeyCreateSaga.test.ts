...
import { apiKeyCreate, apiKeyCreateFetch, ApiKeyDataInterface } from '../actions';
...
describe('api keys saga', () => {
	...
	const expectedpdateApiKeyFetchError = [apiKeyCreateFetch(fakePayload), alertPush(fakeError)];
