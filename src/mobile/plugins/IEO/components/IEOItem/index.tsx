...
const renderer = ({ days, hours, minutes, seconds, completed }) => {
	if (completed) {
		...
		return <span id="ieo-item-mobile__timer">00:00:00:00</span>;
	} else {
		// render a countdown
		return (
			<span id="ieo-item-mobile__timer">
...
export const IEOItem: React.FC<SaleItemProps> = (props: SaleItemProps) => {
	...
	return (
		<div className="ieo-item-mobile" onClick={handleDetailClick}>
			<span className="ieo-item-mobile__badge" style={{ backgroundColor: saleBadgeColor }}>
				{saleType}
			</span>
			<div className="row">
				<div className="col-6">
			...
			<div className="row">
				...
				<div className="col-6 d-flex">
					<span className="text-bold">
						{countdownTitle}: <Countdown date={countdownTime} renderer={renderer} />
					</span>
				</div>
			</div>
			<hr />
