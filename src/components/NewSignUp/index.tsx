...
import { NewCustomInput, PasswordStrengthMeter } from '..';
...
export const NewSignUpForm = (props: NewSignUpFormProps) => {
		...
		<SignUpStyle>
			<div className="cr-sign-up-form" onKeyPress={handleEnterPress}>
				<div className="cr-sign-up-form__form-content">
					...
					{props.renderCaptcha}
					<div className="cr-sign-up-form__button-wrapper mt-4 col-12">
						<Button
							block={true}
							type="button"
