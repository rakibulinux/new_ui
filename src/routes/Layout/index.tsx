...
import { TradingScreen as TradingScreen1 } from '../../plugins/Trading/screens/TradingScreen';
...
class LayoutComponent extends React.Component<LayoutProps, LayoutState> {
  ...
  public render() {
    const { colorTheme, isLoggedIn, isMobileDevice, userLoading, location, configsLoading, platformAccessStatus } = this.props;
    ...
    return (
      <div className={`container-fluid pg-layout ${tradingCls}`}>
        <Switch>
          ...
          <Route exact={false} path="/trading/:market?" component={TradingScreen1} />
