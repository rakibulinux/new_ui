...
import { ApiKeyDataInterface, apiKeyUpdate, apiKeyUpdateFetch } from '../actions';
...
describe('api keys saga', () => {
	...
	const expectedpdateApiKeyFetchError = [apiKeyUpdateFetch(fakePayload), alertPush(fakeError)];
