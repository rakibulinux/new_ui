  ...
  const getTabListInfo = () => {
    const result = [
      {
        ...
        content:
          tabKeyActiveState === intl.formatMessage({ id: 'page.body.trade.tab.marketTrades' }) ? <RecentTradesMarket /> : null,
      },
    ];
    ...
    if (userLoggedIn) {
      result.push({
        ...
        content: tabKeyActiveState === intl.formatMessage({ id: 'page.body.trade.tab.myTrades' }) ? <RecentTradesYours /> : null,
      });
    }
