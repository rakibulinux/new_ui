			...
			<div className="home-page__about-us">
				<div className="container">
					...
					<p className="sub-title">
						We provide secure and trusted digital asset trading services for users from over 100 countries and regions
						around the globe.
					</p>
					<ul className="feature">
						<li>
							...
							<p>
								...
								choices. Give you the key to access the digital world.
							</p>
						</li>
						<li>
							...
							<p>
								...
								Protect your asset security all day long.
							</p>
						</li>
						<li>
							...
							<p>
								...
								most stable and efficient user experience.
							</p>
						</li>
					</ul>
				</div>
			...
			<div className="homepage__feature" style={{ paddingBottom: '72px' }}>
				<div className="container">
					...
					<div className="pc-index-download">
						<div
							className="pc-index-download-pic"
