...
export type OrdersAction = OrderExecuteFetch | OrderExecuteData | OrderExecuteError | SetCurrentPrice | SetAmount | SetOrderType;
...
export const orderExecuteError = (payload: OrderExecuteError['payload']): OrderExecuteError => ({
