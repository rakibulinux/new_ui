    ...
    const columns = [
        {
            ...
            render: rank => {
                if (rank === 1) {
                    return (
                        <img className="trading-rank__icon-mobile" src={RankOne} alt="rank 1" />
                    )
                }
                if (rank === 2) {
                    return (
                        <img className="trading-rank__icon-mobile" src={RankTwo} alt="rank 2" />
                    )
                }
                if (rank === 3) {
                    return (
                        <img className="trading-rank__icon-mobile" src={RankThird} alt="rank 3" />
                    )
                }
                return rank;
            }
        ...
        <div id="trading-competition-ranking">
            <div className="row">
                <div className="col-12 mt-3 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <h4 className="mt-3" style={{ color: '#FFC48Eff', fontWeight: 'bold' }}>{data[0] ? data[0].uid : 'Winner'}</h4>
                </div>
            </div>
