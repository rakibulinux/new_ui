...
import { LayoutRegisterAndLogin, NewLogin, TwoFactorAuth } from '../../components';
import { EMAIL_REGEX, ERROR_EMPTY_PASSWORD, ERROR_INVALID_EMAIL, setDocumentTitle } from '../../helpers';
import { IntlProps } from '../../index';
import { StyleLoginScreen } from './styleNewLoginScreen';
...
const SignIn: React.FC<Props> = props => {
	...
	const renderSignInForm = () => {
		...
		return (
			<StyleLoginScreen className="group-login col-md-5 col-12">
				<div className="qr">
					<img src={QRCode} />
				</div>
				<div className="title">
	...
	return (
		<LayoutRegisterAndLogin
			className={className}
			component={require2FA ? render2FA() : renderSignInForm()}
		></LayoutRegisterAndLogin>
	);
};
...
export const NewSignInScreen = compose(
	injectIntl,
	withRouter,
