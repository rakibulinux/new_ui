...
import { ApiKeyDataInterface, apiKeysData, apiKeysFetch } from '../actions';
...
describe('api keys saga', () => {
	...
	const expectedApiKeysFetchSuccess = [apiKeysFetch(), apiKeysData(fakeApiKeys)];

	const expectedApiKeysFetchError = [apiKeysFetch(), alertPush(fakeError)];
