...
import { BuyIEOComponent, CautionsDetail, InformationIEO, BuyersHistory, BuyHistory } from '../../containers';
import { useHistory } from 'react-router';
import { useParams } from 'react-router';
import { useDispatch, useSelector } from 'react-redux';
import { selectIEOItem, selectUserInfo, findIEOById } from '../../../../../modules';

export const IEOMobileDetailScreen = () => {
		...
		if (user.uid) {
			return (
				<div className="ieo-detail-screen__buy-history col-12 d-flex flex-wrap justify-content-center">
					...
					<div className="col-md-12 col-xl-6 mt-5">
				...
				<div className="row">
					{loading ? (
						...
						<div className="d-flex flex-wrap justify-content-center">
							<div className="col-md-10 ieo-detail-screen__body__buy" style={{ backgroundColor: '#c' }}>
								<BuyIEOComponent
