...
describe('Saga: memberLevelsFetchSaga', () => {
	...
	const expectedBeneficiariesActionsFetch = [memberLevelsFetch(), memberLevelsData(fakeMemberLevels)];

	const expectedBeneficiariesActionsError = [memberLevelsFetch(), memberLevelsError()];
