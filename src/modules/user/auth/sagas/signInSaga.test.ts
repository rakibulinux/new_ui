...
describe('SignIn saga', () => {
	...
	const expectedActions2FAError = [signIn(fakeCredentials)];
	const expectedActionsNetworkError = [signIn(fakeCredentials), signInError({ code: 500, message: ['Server error'] })];
