...
import { Modal, NewSignUpForm, TemplateTitleRegisterAndLogin, LayoutRegisterAndLogin } from '../../components';
import { GeetestCaptcha } from '../../containers';

import { StyleSignUpScreen } from './StyleSignUp';
import {
	EMAIL_REGEX,
	ERROR_INVALID_EMAIL,
...
export const NewExtractRefID = (props: RouterProps) => new URLSearchParams(props.location.search).get('refid');
...
class SignUp extends React.Component<Props> {
	...
	public render() {
		...
		const SignUp = (
			<StyleSignUpScreen className="sign-up-screen col-md-5 col-12">
				<TemplateTitleRegisterAndLogin
					title="Create a free account"
					className="sign-up-header m-auto"
		...
		return <LayoutRegisterAndLogin component={SignUp} />;
	}
...
export const NewSignUpScreen = compose(
	injectIntl,
	withRouter,
