...
import { applogicUrl, authUrl, finexUrl, sunshineUrl, stakeUrl, tradeUrl, withCredentials, ieoAPIUrl } from './config';
...
export interface RequestOptions {
	apiVersion: 'applogic' | 'peatio' | 'barong' | 'finex' | 'sunshine' | 'ieo' | 'stake';
	withHeaders?: boolean;
	headers?: Object;
}
