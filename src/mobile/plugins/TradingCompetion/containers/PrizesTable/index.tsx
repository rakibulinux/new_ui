...
export const PrizeTable: React.FC<PrizeTableProps> = (props: PrizeTableProps) => {
	...
	const columns = [
		{
			...
			render: rank => {
				if (rank === 1) {
					return <img className="rank-icon-mobile" src={RankOne} alt="rank 1" />;
				}
				if (rank === 2) {
					return <img className="rank-icon-mobile" src={RankTwo} alt="rank 2" />;
				}
				if (rank === 3) {
					return <img className="rank-icon-mobile" src={RankThird} alt="rank 3" />;
				}
	...
	return (
		<div id="prize-table-mobile" className="container-fluid">
			<div className="row">
