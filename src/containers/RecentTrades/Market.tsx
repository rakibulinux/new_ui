...
import { Market, PublicTrade, RootState, selectCurrentMarket, selectCurrentPrice, setCurrentPrice } from '../../modules';
	...
	public render() {
		return (
			<div className="pg-recent-trades__markets">
				<Table data={this.getTrades(this.props.recentTrades)} header={this.getHeaders()} onSelect={this.handleOnSelect} />
			</div>
		);
	}
...
const RecentTradesMarket = compose(injectIntl, connect(mapStateToProps, mapDispatchToProps))(RecentTradesMarketContainer) as any; // tslint:disable-line
