...
class LunarTutorial extends React.Component<LunarTutorialProps, LunarTutorialState> {
	...
	public awardDetailsRender = () => {
		...
		return (
			<div className="table-award-detail">
	...
	public depositTableRender = () => {
		...
		const columns: ColumnsType<Lot> = [
			...
			},
			{
				...
				render: (status, record) => {
					...
					return (
						<Button type="primary" onClick={() => this.handleClickPlay(record.txid)}>
							PLAY
						</Button>
					);
				},
		...
		return (
			<div className="table-deposit-detail">
				...
				<div className="container-fluid pg-lunar-tutorial__inner">
					...
					<div className="pg-lunar-tutorial-content">
						...
						<div className="pg-lunar-tutorial-content-requirement">
							...
							<p>
								- You must have a USDT wallet address in the <a onClick={this.toWalletPage}>WALLET</a> directory
								to receive the reward, if not, you can go to <a onClick={this.toWalletPage}>WALLET</a> -{'>'} USDT
