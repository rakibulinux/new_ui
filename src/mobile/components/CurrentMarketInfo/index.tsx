	...
	return (
		<div className="pg-mobile-current-market-info">
			...
			<div className="pg-mobile-current-market-info__right">
				...
				<div className="pg-mobile-current-market-info__right__col">
					<span className={currentMarketChangeClass}>{Decimal.format(currentMarketTicker.volume, 6, ',')}</span>
					<span className={currentMarketChangeClass}>{Decimal.format(currentMarketTicker.high, 4, ',')}</span>
					<span className={currentMarketChangeClass}>{Decimal.format(currentMarketTicker.low, 4, ',')}</span>
				</div>
			</div>
			<Modal
