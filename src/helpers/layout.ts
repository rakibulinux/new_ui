...
const getLayouts = () => {
    ...
    const minGridHeight = gridUnitsToPixels(minTradingChartHeight, rowHeight, margin) +
        gridUnitsToPixels(orderHeight, rowHeight, margin) + margin * 3;
    ...
    /* const marketsHeight = gridHeight >= minGridHeight ?
        pixelsToGridUnits(gridHeight - margin, rowHeight, margin) - recentTradesHeight + margin - 3.3 :
        minMarketsHeight; */

    return {
        lg: [
            { x: 6, y: 40, w: 12, h: orderHeight, i: '1', minH: orderHeight, maxH: orderHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
            { x: 6, y: 0, w: 12, h: tradingChartHeight, i: '2', minH: minTradingChartHeight, minW: 5, isDraggable: isDraggable, isResizable: isResizable },
            { x: 0, y: 0, w: 6, h: orderBookHeight, i: '3', minH: minOrderBookHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
            { x: 6, y: 80, w: 24, h: 17, i: '4', minH: minOpenOrdersHeight, minW: 5, isDraggable: isDraggable, isResizable: isResizable },
            { x: 19, y: 40, w: 6, h: orderHeight, i: '5', minH: minRecentTradesHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
            { x: 19, y: 0, w: 6, h: tradingChartHeight, i: '6', minH: minMarketsHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
        ],
        md: [
            { x: 6, y: 40, w: 12, h: orderHeight, i: '1', minH: orderHeight, maxH: orderHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
            { x: 6, y: 0, w: 12, h: tradingChartHeight, i: '2', minH: minTradingChartHeight, minW: 5, isDraggable: isDraggable, isResizable: isResizable },
