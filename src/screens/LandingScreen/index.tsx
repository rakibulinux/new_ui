			...
			<div className="pg-landing-screen__market-info">
				<div className="pg-landing-screen__market-info__wrap">
					<div className="pg-landing-screen__market-info__wrap__title">
						<div className="pg-landing-screen__market-info__wrap__title__head">Welcome New Trader</div>
						<div className="pg-landing-screen__market-info__wrap__title__headx">Join CircleEx Exchange</div>
						<div className="pg-landing-screen__market-info__wrap__title__sub">Bonus 100 CX to 1000 Trader First</div>
						<div className="pg-landing-screen__market-info__wrap__title__subx">Event Start In 15th November 2020</div>
					</div>
					<div className="pg-landing-screen__market-info__wrap__box">
						<div className="pg-landing-screen__market-info__wrap__box__content">
							...
							<div className="pg-landing-screen__market-info__wrap__box__content__subx">
								...
								<a href="https://www.facebook.com/CircleEx" target="blank">
									<img src={FacebookIcon} alt="facebook" />
								</a>
								<a href="https://twitter.com/CircleEx" target="blank">
									<img src={TwitterIcon} alt="twitter" />
								</a>
								<a href="https://t.me/CircleEx_office" target="blank">
		...
		return (
			<div className="pg-landing-screen__partner-list">
				<div className="pg-landing-screen__partner-list__wrap">
					<div className="pg-landing-screen__partner-list__wrap__title">PARTNER</div>
		...
		return (
			<div className="pg-landing-screen__roadmap-list">
				<div className="pg-landing-screen__roadmap-list__wrap">
					<div className="pg-landing-screen__roadmap-list__wrap__title">Roadmap's CircleEx Exchange</div>
				...
				<div className="pg-landing-screen__market-feature__wrap">
					<div className="pg-landing-screen__market-feature__wrap__left" style={{ background: '#2B3139' }}>
						<div className="item-feature">
							<div>
								<img src={FeaturesCustomizeIcon} alt="Screen" />
							</div>
							<div>
								<h4>User-friendly</h4>
						...
						<div className="item-feature">
							<div>
								<img src={FeaturesExchangeIcon} alt="Exchange" />
							</div>
							<div>
						...
						<div className="item-feature">
							<div>
								<img src={FeaturesAPIIcon} alt="Bank" />
							</div>
							<div>
								<h4>CircleEx Bank</h4>
						...
						<div className="item-feature">
							<div>
								<img src={FeaturesCommunityIcon} alt="Device" />
							</div>
							<div>
								<h4>Devices Covered</h4>
								<span>
									Whenever there is a network, you can manage your crypto assets with Web/iOS/Android everywhere
								</span>
							</div>
						</div>
					</div>
					...
					<div className="pg-landing-screen__market-feature__wrap__right">
						...
						<div className="item-mobile__mobile">
							<div className="item-mobile__title">Mobile Version comming soon !!!</div>
...
export const LandingScreen = compose(injectIntl, connect(mapStateToProps, null))(Landing) as React.ComponentClass;
