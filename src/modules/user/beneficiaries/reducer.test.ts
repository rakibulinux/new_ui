...
describe('Beneficiaries reducer', () => {
	...
	it('should handle beneficiariesActivateData', () => {
		...
		expect(beneficiariesReducer(initialBeneficiariesState, actions.beneficiariesActivateData(fakeActiveBeneficiary))).toEqual(
			expectedState,
		);
	});
	...
	it('should handle beneficiariesCreateData', () => {
		...
		expect(beneficiariesReducer(initialBeneficiariesState, actions.beneficiariesCreateData(fakeBeneficiary))).toEqual(
			expectedState,
		);
	});
	...
	it('should handle beneficiariesDeleteData', () => {
		...
		expect(beneficiariesReducer(initialBeneficiariesState, actions.beneficiariesDeleteData(fakeSuccessPayload))).toEqual(
			expectedState,
		);
	});
