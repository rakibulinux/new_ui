...
import { alertPush, RootState, selectMobileDeviceState, selectSendAddressesSuccess, sendAddresses } from '../../../modules';
...
class AddressComponent extends React.Component<Props, State> {
	...
	private handleCheckButtonDisabled = () => {
		const { address, city, fileScan, postcode } = this.state;
		...
		return !addressValid || !cityValid || !postcodeValid || !fileScan.length;
	};
...
export const Address = compose(injectIntl, withRouter, connect(mapStateToProps, mapDispatchToProps))(AddressComponent) as any; // tslint:disable-line
