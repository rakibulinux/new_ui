...
export const GET_TOTAL_BUYERS = 'buy/GET_TOTAL_BUYERS';
export const TOTAL_BUYERS_DATA = 'buy/TOTAL_BUYERS_DATA';
export const TOTAL_BUYERS_ERROR = 'buy/TOTAL_BUYERS_ERROR';
