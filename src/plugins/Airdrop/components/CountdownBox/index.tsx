		...
		return (
			<div id="container-countdown">
				...
				<div id="countdown-timer">
					<div className="days">
						<div className="numbers">{this.props.days}</div>days
					</div>
					<div className="hours">
						<div className="numbers">{this.props.hours}</div>hours
					</div>
					<div className="minutes">
						<div className="numbers">{this.props.minutes}</div>minutes
					</div>
					<div className="seconds">
						<div className="numbers">{this.props.seconds}</div>seconds
					</div>
				</div>
				<h1>{title}</h1>
			</div>
