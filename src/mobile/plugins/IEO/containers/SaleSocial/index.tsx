    ...
    return (
        <React.Fragment>
            ...
            <div className="social-item-mobiles">
                ...
                {
                    props.instagram ? <div> <a href={props.instagram} target="_blank"><InstagramOutlined className="social-item-mobile" /></a> </div> : ''

                }
                {
                    props.linkedin ? <div> <a href={props.linkedin} target="_blank"><LinkedinOutlined className="social-item-mobile" /></a> </div> : ''
